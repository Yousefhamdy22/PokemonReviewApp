    ...
    public partial class InitalDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryOwner", x => new { x.CountriesId, x.OwnersId });
                    table.ForeignKey(
                        name: "FK_CountryOwner_Countries_CountriesId",
                        column: x => x.CountriesId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CountryOwner_Owners_OwnersId",
                        column: x => x.OwnersId,
